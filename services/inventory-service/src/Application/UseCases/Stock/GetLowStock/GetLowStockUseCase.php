...
namespace Src\Application\UseCases\Stock\GetLowStock;
 ...
 * 
 * Returns all products with stock below minimum quantity
 */
final class GetLowStockUseCase
{
    ...
    {
        $stocks = $this->stockRepository->findLowStock();
